                        ...
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr
                                    ...
                                    <td
                                        className="px-6 py-4 text-xs font-medium text-gray-900 dark:text-white">
                                        <div className={`h-${isCollapsed ? '40' : 'auto'} overflow-hidden`}>
                                            <p>
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem quisquam corrupti odit omnis cupiditate quis, autem aliquid veritatis doloribus consequatur sapiente quam ut esse ullam. borum id?
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo dolor, iste quam consequatur natus illum dicta quaerat quae, libero ratione aspernatur, corporis ab deleniti eveniet at consequuntur praesentium tenetur nam.
                                                Sint amet facere aliquam maxime dolor doloremque tempora ullam. Fugit soluta adipisci rem magnam mollitia minima deserunt harum aspernatur expedita iste blanditiis velit, saepe accusamus explicabo vitae officia ut. Neque.
                                                Aliquam placeat modi fuga commodi amet expedita nisi architecto enim perferendis quibusdam voluptatum quisquam, reiciendis mollitia? Rerum non, nisi pariatur eius alias sint accusantium dicta reprehenderit voluptates eveniet id consectetur
                                            </p>
                                        </div>
                                        <button
